                  ...
                  <div>
                    ...
                    {exp.website ? (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-base font-medium text-cyan-300/80 hover:text-cyan-300 transition-colors group/link"
                      >
                        {exp.company}
