      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-foreground/60 max-w-xl mx-auto">
            Engineering fundamentals built progressively toward innovation and
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <Badge
                          variant="outline"
                          className="border-white/10 text-foreground/40 text-xs"
                        >
                          {edu.type}
                        </Badge>
                      </div>
                    ...
                    <span className="flex items-center gap-1.5">
                      ...
                      {edu.website ? (
                        <a
                          ...
                          className="inline-flex items-center gap-1 hover:text-cyan-300 transition-colors group/link"
                        >
                          {edu.school}
